...
// ArtGalleryCanvas.java - Handles visualization of polygon, trapezoids, partitions, triangulations, dual graph, coloring, and guards.
...
public class ArtGalleryCanvas extends JPanel {

    private static final Color COLOR_BACKGROUND = Color.WHITE;
    private static final Color COLOR_POLYGON = new Color(50, 50, 50);
    private static final Color COLOR_TRAPEZOID = new Color(255, 165, 0, 150);
    private static final Color COLOR_PARTITION = new Color(0, 100, 255);
    private static final Color COLOR_TRIANGULATION = new Color(220, 220, 220);
    private static final Color COLOR_DUAL_GRAPH = new Color(239, 71, 111);
    private static final Color COLOR_LABEL_VERTEX = new Color(0, 0, 0);
    private static final Color COLOR_LABEL_EDGE = new Color(0, 102, 0);
    private static final Color COLOR_GUARD = new Color(220, 20, 60);
    ...
    private void drawLabelsAndInfo(Graphics2D g) {
        ...
        for (int i = 0; i < polygon.size(); i++) {
            ...
            int offsetX = (int) (-12 * dy / length);
            int offsetY = (int) (12 * dx / length);
    ...
    private void drawColoredVertices(Graphics2D g) {
        ...
        Color[] colors = {new Color(220, 20, 60), new Color(30, 144, 255), new Color(50, 205, 50)};
